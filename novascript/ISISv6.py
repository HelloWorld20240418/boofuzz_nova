...
def fuzzing_define_proto(session):
    s_initialize(name="ISIS_V6_HELLO")
    ...
    with s_block("ISIS_HELLO"):
        s_bytes(value=bytes([0x01]), size=1, max_len=1, name='Circuit type: Level 1 and 2 ', fuzzable=False)
        s_bytes(value=bytes([0x00,0x00,0x00,0x00,0x00,0x02]), size=6, max_len=6, name='SystemID {Sender of PDU}', fuzzable=False)
        s_bytes(value=bytes([0x00,0x09]), size=2, max_len=2, name='Holding_timer', fuzzable=False)
        ...
        s_bytes(value=bytes([0x00,0x00,0x00,0x00,0x00,0x02,0x01]), size=7, max_len=7, name='SystemID {Designated IS}', fuzzable=False)
        ...
        s_bytes(value=bytes([0x06]), size=1, max_len=1, name='ISNEIGHBOR_TYPE', fuzzable=False)
        s_bytes(value=bytes([0x06]), size=1, max_len=1, name='ISNEIGHBOR_Length', fuzzable=False)
        s_bytes(value=bytes([0x00, 0xe0, 0xfc, 0x1c,0x6e,0x5a]), size=6, max_len=6, name='ISNEIGHBOR', fuzzable=False)
        s_bytes(value=bytes([0xe8]), size=1, max_len=1, name='TYPE_ipv6', fuzzable=False)
        s_bytes(value=bytes([0x10]), size=1, max_len=1, name='Length_ipv6', fuzzable=False)
        s_bytes(value=bytes(src_ip), size=16, max_len=16, name='ip_addressv6', fuzzable=False)
        ...
        s_bytes(value=bytes([0x8e]), size=1, max_len=1, name='Protocols_Supported_address', fuzzable=False)
        ...
        s_bytes(value=bytes([0x8b]), size=1, max_len=1, name='Padding_Length6', fuzzable=False)
        s_string("0000",size=139,max_len=139,name='data6')


    session.connect(s_get('ISIS_V6_HELLO'))
